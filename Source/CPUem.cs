...
class CPUem
{
    ...
    public Assembler2 getCompatibleAssembler()
    {
        ...
        Instr.Add("nop",    new Instruction(0x00,false,false,false,false,false,false,false,false,0));
        ...
        if (type == 0) { //arithmetic
            ...
            switch (inst) {
                ...
                case 2://Rd
                    ...
                    break;
                case 3://Wr
                    executionTime += memory.writeMem(valA,(UInt16)((valB+valC) & 0x0000ffff)) -1;
                    break;
                case 4://Push
    ...
    private int floatInst(int ins, long regA) {
        ...
        switch(ins) {
                ...
                case 4://fmerge
                    ...
                    {//the merge operation requires both stacks to be synchronised
                        fsbc[1] += 1;
                        fsbc[0] = fsbc[1];
                    }
                    int fsp1 = fsp[0];
